      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-300">
            Join us to manage your timetables
          </p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <PersonIcon className="text-slate-400 text-lg" />
                </div>
                <input
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`py-3 px-4 rounded-lg border-2 transition-all ${
                    userType === "student"
                      ...
                      : "border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-500"
                  }`}
                >
                  <PersonIcon className="text-lg mb-1" />
                ...
                >
                  <SchoolIcon className="text-lg mb-1" />
