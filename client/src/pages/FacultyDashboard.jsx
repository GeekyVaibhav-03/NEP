...
export default function FacultyDashboard() {
  ...
  const fetchData = async () => {
    try {
      // Load demo faculty timetable data instead of fetching from API
      const demoTimetable = generateDemoFacultyTimetable();
      setTimetables([demoTimetable]);

      // Load demo upcoming classes for faculty
      const demoUpcomingClasses = generateDemoUpcomingClasses(false);
